...
const techStack = [
  ...
  },
  {
    ...
    langName: "Wordpress",
    langDesc: "<li>WordPress is a free, open-source content management system (CMS) that allows users to create and manage websites</li>",
  },
  {
    langImage:"assets/images/techstack-page/java.svg",
    langName:"Java",
    langDesc:"<li>Java is a programming language and computing platform that's used to create applications for many devices.</li>"
  },
];
